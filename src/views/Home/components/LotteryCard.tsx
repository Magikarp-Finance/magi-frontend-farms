...
const Block = styled.div`margin-bottom: 16px;`

const CardImage = styled.img`margin-bottom: 16px;`
	...
	return (
		<StyledLotteryCard>
			<CardBody>
				...
				<CardImage src='/images/ticket.svg' alt='Gya logo' width={64} height={64} />
				<Block>
					<CakeWinnings />
					<Label>{TranslateString(552, 'GYA to Collect')}</Label>
				</Block>
				<Block>
					<LotteryJackpot />
