...
import { Heading, Card, CardBody, CardFooter, Text, AltTokenRoundIcon ,Flex, Skeleton } from '@pancakeswap-libs/uikit'
        ...
        <CardHeading>
          <Left>
            ...
            <PrizeCountWrapper>
              ...
              <Heading size="lg">{lotteryPrizeWithCommaSeparators} MAGI</Heading>
            </PrizeCountWrapper>
          </Left>
          <Right>
