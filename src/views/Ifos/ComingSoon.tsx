...
const Block = styled.div`margin-bottom: 32px;`
...
const LiquidityLink = styled.a`color: ${({ theme }) => theme.colors.primary};`
			...
			<Content>
				<div>
					<Block>
						...
						<Text mb={3}>
							<LiquidityLink href='https://v1exchange.pancakeswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82'>
