...
const GridItem = styled.div`margin-bottom: '10px';`
	...
	return (
		<Modal title='ROI' onDismiss={onDismiss}>
			<Grid>
				...
				<GridItem>
					<Text fontSize='12px' bold color='textSubtle' textTransform='uppercase' mb='20px'>
						{TranslateString(999, 'GYA per $1000')}
					</Text>
				</GridItem>
				{/* 1 day row */}
				<GridItem>
			...
			<Flex justifyContent='center'>
				<LinkExternal href={`https://v1exchange.pancakeswap.finance/#/add/${liquidityUrlPathParts}`}>
