...
background: linear-gradient(
  ...
  rgba(255,128,0,1) 0%,
  rgba(255, 154, 0, 1) 10%,
  rgba(232,211,59,1) 20%,
  rgba(255, 154, 0, 1) 30%,
  rgba(255,128,0,1) 40%,
  rgba(255, 154, 0, 1) 50%,
  rgba(232,211,59,1) 60%,
  rgba(255, 154, 0, 1) 70%,
  rgba(255,128,0,1) 80%,
  rgba(255, 154, 0, 1) 90%,
  ...
  background-image: linear-gradient( 177.8deg,   9.2%, 86.8% );
...
const PoolCard: React.FC<HarvestProps> = ({ pool }) => {
  ...
  return (
    ...
    {isHighlighted && isCardActive  ?  <StyledCardAccent/>:' ' }
      ...
      <div style={{ padding: '24px' }}>
        ...
        <StyledDetails>
          ...
          {isFinished || isOldSyrup || !apy ? (
            ...
            <Balance fontSize="14px" isDisabled={isFinished} value={apy} decimals={8} unit="%" />
          )}
        </StyledDetails>
